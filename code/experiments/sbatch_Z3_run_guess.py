...
output_dir = "/NL/stackexchange/work/matrix-completion/batch-out-Z3-guess"
...
for sat_2d, sat_1d, ctx_id, seed, rank, i_loo, j_loo in df[['2D_sat', '1D_sat', 'context_id', 'seed', 'rank', 'i_loo', 'j_loo']].values:
    ...
    cmd = f'sbatch --mem=4000 --time=20 -o "{stdout_file}" ./sbatch_Z3_job_guess.sh {in_file} {seed} {i_loo} {j_loo} {sat_2d} {sat_1d}'
    # print(cmd)
    os.system(cmd)
